...
public class ZukeHook {
    ...
    public void createTestStbModel() throws DawgTestException {
        String testSTBModel = TestContext.getCurrent().get(DawgHouseConstants.CONTEXT_TEST_STB_MODEL);
    ...
    public void createStbModelForAdvanceSearch() throws DawgTestException {
        String testSTBId = TestContext.getCurrent().get(DawgHouseConstants.CONTEXT_TEST_STB_ID);
        if (null == testSTBId) {
     ...
     * @throws DawgTestException 
     */
    @After("@toggleall, @rest_stb_add")
    public void clearAddedTagsandSTBs() throws DawgTestException {
        DawgCommonUIUtils.getInstance().removeAllTagsAddedInTest();
        DawgCommonUIUtils.getInstance().deleteSTBsOrModelsFromList(DawgHouseConstants.CONTEXT_TEST_STBS);
    }
