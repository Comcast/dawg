...
<html style="width:100%;height:100%">
    ...
    <img id="<%=rem%>select" src='<c:url value="/images/remotes/xr2/keys/ok.png" />' onmousedown="clickRemoteButton(event,'ENTER', true)" onmouseup="clickRemoteButton(event,'ENTER', false)" alt="" style="width:22.5%;left:39.5%;top:34.5%;position:absolute"/>
</html>
