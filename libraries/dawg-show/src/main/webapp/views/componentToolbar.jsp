...
<html style="background-color: white;width:100%" >
    ...
    <div id ="toolbarDiv" style="width:100%;height:<%=toolbarHeight %>px">
    ...
    <div id="hideButtonDiv" style="width:90%;height:40px; text-align:center">
        <canvas id="hideButton" width="200px" height="40px" onclick="hw.onclick()"></canvas>
    </div>

    <script type="text/javascript">
            var menuBox = new MenuBox($('#menuBox')[0]);
            var toolbar = new ComponentToolbar(90, 75, <%= rows %>);
