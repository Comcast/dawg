...
public class TestConstants {
    ...
    public static final String MODEL_UPDATE_REST_URI = TestServers.getHouse() + "models/";

    /** Tag update rest URI. */
    public static final String TAG_UPDATE_REST_URI = TestServers.getHouse() + "devices/update/tags/";
